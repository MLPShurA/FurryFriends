        ...
        try:
            ...
            if usuario_data:  # Modo editar
                query_update_detalle = """
                    UPDATE usuarios_detalle SET nombres=%s, apellidos=%s, cedula=%s, telefono=%s, correo_electronico=%s, direccion=%s 
                    WHERE id=%s
                """
                ...
                query_detalle = """
                    INSERT INTO usuarios_detalle (nombres, apellidos, cedula, telefono, correo_electronico, direccion, usuario_id)
